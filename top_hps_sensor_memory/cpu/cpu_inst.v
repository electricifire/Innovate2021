	cpu u0 (
		...
		.pvcurrent_external_connection_export   (<connected-to-pvcurrent_external_connection_export>),   //   pvcurrent_external_connection.export
		.pvvoltage_external_connection_export   (<connected-to-pvvoltage_external_connection_export>),   //   pvvoltage_external_connection.export
		.bacurrent_external_connection_export   (<connected-to-bacurrent_external_connection_export>),   //   bacurrent_external_connection.export
		.bavoltage_external_connection_export   (<connected-to-bavoltage_external_connection_export>),   //   bavoltage_external_connection.export
		.vgr_current_external_connection_export (<connected-to-vgr_current_external_connection_export>), // vgr_current_external_connection.export
		.vgs_current_external_connection_export (<connected-to-vgs_current_external_connection_export>), // vgs_current_external_connection.export
		.vgt_current_external_connection_export (<connected-to-vgt_current_external_connection_export>), // vgt_current_external_connection.export
		.vgr_voltage_external_connection_export (<connected-to-vgr_voltage_external_connection_export>), // vgr_voltage_external_connection.export
		.vgs_voltage_external_connection_export (<connected-to-vgs_voltage_external_connection_export>), // vgs_voltage_external_connection.export
		.vgt_voltage_external_connection_export (<connected-to-vgt_voltage_external_connection_export>), // vgt_voltage_external_connection.export
		.phase_external_connection_in_port      (<connected-to-phase_external_connection_in_port>),      //       phase_external_connection.in_port
		.phase_external_connection_out_port     (<connected-to-phase_external_connection_out_port>)      //                                .out_port
	);
